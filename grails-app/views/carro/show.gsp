...
<html>
    ...
    <body>
        ...
        <div id="show-carro" class="content scaffold-show" role="main">
            ...
            <f:display bean="carro" />
            <g:form resource="${this.carro}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.carro}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
